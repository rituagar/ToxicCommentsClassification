...
class CNN(object):
    ...
    def __init__(
      ...
      embedding_size, filter_sizes, num_filters, l2_reg_lambda=0.0):
        ...
        self.input_x = tf.placeholder(tf.int32, [Config.batch_size, sequence_length], name="input_x")
        self.input_y = tf.placeholder(tf.float32, [Config.batch_size], name="input_y")
